...
public class myTestCases {
	...
	Connection con; 
	java.sql.Statement stmt ; /// the quiry 
	ResultSet rs ;
	...
	public void Setup() throws SQLException {
		con = DriverManager.getConnection("jdbc:mysql://localhost:3306/classicmodels", "root", "Eman");
	}
	...
	public void addData() throws SQLException {
		...
		String Query = "INSERT INTO customers (customerNumber, customerName, contactLastName, contactFirstName, phone, addressLine1, city,country )"
				+ "VALUES (79, 'ABC', 'abedalraheem', 'saqqa', '123-456-7890', 'Amman', 'Amman' ,'jordan')";
		;
	...
	public void updateData() throws SQLException {
		...
		String Query = "update customers set customerName = 'auto' where customerNumber = 79 ";
